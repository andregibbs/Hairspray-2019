                 ...
                 <Container fluid={true} className="py-2 pb-lg-5">
                   <Row className="text-center m-0 mt-4 d-xl-flex text-center">
                        ...
                        <Col xs={12} xl={4}>
                           ...
                           <br /><br/>
                            <p><span className="text--bold">Look who’s back! Don’t miss Michael Ball reprising his Olivier Award-winning role as Edna Turnblad in Hairspray. The huge-hearted, smash-hit musical arrives at the magnificent London Coliseum from next April until 29 August 2020.</span></p> 
